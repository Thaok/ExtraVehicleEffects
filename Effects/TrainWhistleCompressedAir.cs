...
{
    public class TrainWhistleCompressedAir
    {
        private const string effectName = "Train Whistle Compressed Air";
        ...
        public static EffectInfo CreateEffectObject(Transform parent)
        {
            ...
            audioInfo.m_fadeLength = audioInfo.m_clip.length;
            ...
            var clip = Util.LoadAudioClipFromModDir("Sounds/train-whistle2.ogg");
